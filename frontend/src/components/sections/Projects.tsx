...
const projects = [
  ...
  {
    name: "CRM System",
    desc: "A system to manage customer data",
    tag: "Web App",
    year: "2025",
    stack: ["TypeScript", "Next JS", "MySQL"],
    repoLink: "https://github.com/kevinbalocos/customer-relationship-management-system",
    mockType: "Web App",
  },
  {
    name: "Queueing System",
    desc: "A queuing system to track progress of papers in real time",
    tag: "Web App",
    year: "2025",
